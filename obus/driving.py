...
def find_closest_vertex(current_position, zone_vertices):
    return min(zone_vertices, key=lambda vertex: calculate_distance(current_position, vertex))
...
def navigate_to_zone(start_point, zone_vertices, data, obu):
    closest_vertex = find_closest_vertex(start_point, zone_vertices)
    return navigate_to_point(start_point, closest_vertex, data, obu)

def navigate_to_point(start_point, destination_point, data, obu, max_step_distance=10):
